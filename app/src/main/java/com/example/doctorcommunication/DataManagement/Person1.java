...
public class Person1{
    ...
    public static Symptom[] symptom = {
            ...
            new Symptom("2021.09.05","머리","두통","4","쿡쿡 찌르듯이","시간이 갈수록","피로","몸살이 난것처럼 몸에 힘이 나지 않았다."),
            new Symptom("2021.09.05","머리","두통","6","지끈지끈한","피곤하면","발열"),
            new Symptom("2021.09.05","머리","두통","3","더부룩하며 팽창","음식을 섭취하고 난뒤","피로"),
            ...
            new Symptom("2021.10.08","머리","두통","6","날카로운 통증","시간이 갈수록","피로","하루종일 지속되었다."),
            new Symptom("2021.10.09","머리","두통","8","쿡쿡 찌르듯이","시간이 갈수록","기침"),
            new Symptom("2021.09.10","배","복통","2","단순 통증","피곤하면","메스꺼움"),
            new Symptom("2021.09.10","손목","손목 통증","4","투명하거나 하얀 가래","시간이 갈수록","두통","차가운 물을 마시면 심해진다."),
